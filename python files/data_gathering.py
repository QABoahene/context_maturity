...
def get_artist_album_list(artist_id):
    ...
    albums_info = [(album['name'], album['id']) for album in artist_albums_info_dict['albums']]
    return(albums_info)
...
# print(artist_albums)
print("\nHere are the album(s) and mixtape(s) by " + artist_to_search + " with lyrics on genius.com")
